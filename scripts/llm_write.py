...
# 反 AI 写作铁律（浓缩版，与 references/writing-guide.md 的 Tier 1/2 对齐；实测可把
# humanness composite 压到 <30）。事实准确性由编排 agent 在 brief 里给真实锚点 + Tier-3 终检兜底。
ANTI_AI_SYSTEM = """你是资深中文公众号作者，文风口语、有观点、像真人在聊天。严格遵守反 AI 检测写作铁律：
